...
<head>
    ...
    <title>Notes | NOTIFIER - Keep tracks of your tasks in a smart way</title>
    ...
    <!-- theme stylesheet-->
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/vendor/css/style.blue.css"
          id="theme-stylesheet">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="navbar-header">
                <a href="index.html" class="navbar-brand">
                    ...
                    <div class="brand-text brand-sm"><strong class="text-primary">Noti</strong><strong>fier</strong>
                    </div>
                </a>
...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar" style="background-color: #ffffff">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="#" data-toggle="modal" data-target="#editUser<%= user.getId() %>"> <i
                    class="fas fa-user-edit"></i>EDIT USER </a></li>
        </ul>
    ...
    <div class="page-content" style="background-color: #ffffff">
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    <div class="list-inline-item" style="background-color: #ffffff">
                        <button type="button" data-toggle="modal" data-target="#addNote" class="btn button-add">
                            <i class="fas fa-plus-square"></i>New Note
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <form action="addnote" id="addnoteform" name="addnoteform" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter note name" id="noteName" name="noteName"
                                       class="form-control">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" placeholder="StartDate.." id="startDate" name="startDate"
                                               class="form-control">
                                        <span><label id="startDate-error" class="error" for="startDate"></label></span>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="endDate">END DATE</label>
                                        <input type="date" placeholder="endDate.." id="endDate" name="endDate"
                                               class="form-control">
                                        <span><label id="endDate-error" class="error" for="endDate"></label></span>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="remainderDate">REMAINDER DATE</label>
                                        <input type="date" placeholder="remainderDate" id="remainderDate"
                                               name="remainderDate" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Enter description about note" id="noteDescription"
                                          name="noteDescription" class="form-control"></textarea>
            ...
            <c:forEach items="${NoteList}" var="item">
                <div class="card notebookRow" id="${item.getId()}">
                    <div class="card-header" style="background-color:#676be6; ">
                        <div class="row">
                            <div class="col-3" id="cardname"><a
                                    href="viewnote?noteid=${item.getId()}">${item.getNoteName()}</a></div>
                            <div class="col-2" id="startdate">Start:<br> <span>${item.getStartDate()}</span></div>
                            <div class="col-5" id="Status">Status:<br> <span>${item.getStatus().getStatusName()}</span>
                            </div>
                            <div class="col-1"><a href="deletenote?noteId=${item.getId()}"><i
                                    class="fas fa-trash-alt"></i> </a></div>
                            <div class="col-1"><a href="editnote?noteId=${item.getId()}" data-toggle="modal"
                                                  data-target="#editNote${item.getId()}">

                                <i class="fas fa-pencil-alt"></i> </a></div>
                        </div>

                        <div>
                            <a data-toggle="collapse" href="#myCollapseExample${item.getId()}" aria-expanded="false"
                ...
                <!-- edit note modal -->
                <div id="editNote${item.getId()}" tabindex="-1" role="dialog" aria-labelledby="editNoteLabel"
                     aria-hidden="true"
                     class="modal  fade text-left">
                    <div role="document" class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="editnote" id="editnoteform" name="editnoteform" method="POST">
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" id="notebookId" name="notebookId" value="${NoteBookId}"
                                           class="form-control">
                                    <input type="hidden" id="noteId" name="noteId" value="${item.getId()}"
                                           class="form-control">

                                    <div class="form-group">
                                        <label for="notebookName">NOTE NAME</label>
                                        <input type="text" placeholder="Enter note name" id="noteName" name="noteName"
                                               value="${item.getNoteName()}" class="form-control">
                                        <span><label id="noteName-error" class="error" for="noteName"></label></span>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="startDate">START DATE</label>
                                                <input type="date" placeholder="StartDate.." id="startDate"
                                                       name="startDate" value="${item.getStartDate()}"
                                                       class="form-control">
                                                <span><label id="startDate-error" class="error" for="startDate"></label></span>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="endDate">END DATE</label>
                                                <input type="date" placeholder="endDate.." id="endDate" name="endDate"
                                                       value="${item.getEndDate()}" class="form-control">
                                                <span><label id="endDate-error" class="error"
                                                             for="endDate"></label></span>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="remainderDate">REMAINDER DATE</label>
                                                <input type="date" placeholder="remainderDate" id="remainderDate"
                                                       name="remainderDate" value="${item.getRemainderDate()}"
                                                       class="form-control">
                                                <span><label id="remainderDate-error" class="error"
                                                             for="remainderDate"></label></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="noteStatus">Status</label>
                                        <select id="noteStatus" name="noteStatus" class="form-control mb-3 mb-3">
                                            <option value="Started"    ${item.getStatus().getStatusName() =='Started'? 'selected="true"' : '' } >
                                                Started
                                            </option>
                                            <option value="InProgress" ${item.getStatus().getStatusName() =='InProgress'? 'selected="true"' : '' }>
                                                InProgress
                                            </option>
                                            <option value="Complete"   ${item.getStatus().getStatusName() =='Complete'? 'selected="true"' : '' }>
                                                Complete
                                            </option>
                                        </select>
                                        <span><label id="noteStatus-error" class="error"
                                                     for="noteStatus"></label></span>
                                    </div>

                                    <div class="form-group">
                                        <label for="noteTag">Status</label>
                                        <select id="noteTag" name="noteTag" class="form-control mb-3 mb-3">
                                            <option value="Private" ${item.getTag().getTagName() =='Private'? 'selected="true"' : '' }>
                                                Private
                                            </option>
                                            <option value="Public" ${item.getTag().getTagName() =='Public'? 'selected="true"' : '' }>
                                                Public
                                            </option>
                                        </select>
                                        <span><label id="noteTag-error" class="error" for="noteTag"></label></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Enter description about note" id="noteDescription"
                                                  ...
                                                  class="form-control">${item.getNoteDescription()}</textarea>
        ...
        <!-- Modal for edit user -->
        <div id="editUser<%= user.getId() %>" tabindex="-1" role="dialog" aria-labelledby="editUserLabel"
             aria-hidden="true"
             class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"><strong id="editUsers" class="modal-title">Edit User</strong>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true">x</span></button>
                    </div>

                    <form action="edituser" id="edituser" name="edituser" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Mobile" id="mobile" name="mobile"
                                       value="<%= user.getMobileNumber() %>" class="form-control">
                                <span><label id="mobile-error" class="error" for="mobile"></label></span>
...
<script>
    ...
    $(function () {
        ...
        $("form[name='editnoteform']").validate({
            ...
            messages: {
                noteName: {
                    minlength: "Note name must be greater than two digit",
