...
<head>
    ...
    <title>Login | NOTIFIER - Keep tracks of your tasks in a smart way</title>
            ...
            <div class="col-lg-6">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><a href="#" class="forgot-pass">Forgot Password?</a><br><small>Do not have an account? </small><a href="${pageContext.request.contextPath}/signup" class="signup">Signup</a>
                </div>
              </div>
            </div>
          </div>
